...
wxBEGIN_EVENT_TABLE(wxListMainWindow,wxScrolledWindow)
...
void wxListMainWindow::OnChar( wxKeyEvent &event )
{
    ...
    if ( HasCurrent() )
    {
        wxListEvent le( wxEVT_LIST_KEY_DOWN, GetParent()->GetId() );
...
wxBEGIN_EVENT_TABLE(wxGenericListCtrl,wxControl)
